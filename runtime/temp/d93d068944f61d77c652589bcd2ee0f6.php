<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:87:"C:\myphp_www\PHPTutorial\WWW\tp5\public/../application/index\view\grand\grand_list.html";i:1561978350;s:72:"C:\myphp_www\PHPTutorial\WWW\tp5\application\index\view\public\base.html";i:1561699501;s:72:"C:\myphp_www\PHPTutorial\WWW\tp5\application\index\view\public\meta.html";i:1561524039;s:74:"C:\myphp_www\PHPTutorial\WWW\tp5\application\index\view\public\header.html";i:1561737762;s:72:"C:\myphp_www\PHPTutorial\WWW\tp5\application\index\view\public\menu.html";i:1561973749;s:74:"C:\myphp_www\PHPTutorial\WWW\tp5\application\index\view\public\footer.html";i:1561709989;}*/ ?>
...
<section class="Hui-article-box">
	...
	<div class="Hui-article">
		<article class="cl pd-20">
			...
			<a href="javascript:;" onclick="member_add('添加班级','<?php echo url('grand/grandAdd'); ?>','','510')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加班级</a>
				...
				<table class="table table-border table-bordered table-hover table-bg table-sort">
					<thead>
						<tr class="text-c">
							...
							<th width="40">创建人</th>
							<th width="90">创建时间</th>
							<th width="200">班级描述</th>
							<th width="200">包含课程</th>
							<th width="100">操作</th>
						</tr>
					</thead>
					<tbody>
					<?php if(is_array($data['list']) || $data['list'] instanceof \think\Collection || $data['list'] instanceof \think\Paginator): if( count($data['list'])==0 ) : echo "" ;else: foreach($data['list'] as $key=>$grand): ?>
						<tr class="text-c">
							<td><input type="checkbox" value="1" name=""></td>
							<td><?php echo $grand['id']; ?></td>
							<td>
							<u style="cursor:pointer" class="text-primary" onclick="member_show('\<?php echo $grand['name']; ?>','<?php echo url('grand/grandShow'); ?>','<?php echo $grand['id']; ?>','1000','600')"><?php echo $grand['name']; ?></u>
							</td>
							<td><?php echo $grand['creator_name']; ?></td>
							<td><?php echo date("Y-m-d H:i:s",$grand['create_time']); ?></td>
							<td><?php echo $grand['detail']; ?></td>
							<td><?php echo $grand['programName']; ?></td>
							<td class="td-manage">
							<a title="编辑" href="javascript:;" onclick="member_edit('编辑','<?php echo url('grand/grandEdit'); ?>','<?php echo $grand['id']; ?>','','510')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
							<a title="删除" href="javascript:;" onclick="member_del(this,'<?php echo $grand['id']; ?>')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
						</tr>
...
$(function(){
	$('.table-sort').dataTable({
		...
		"aoColumnDefs": [
		  ...
		  {"orderable":false,"aTargets":[7]}// 制定列不参与排序 排序规则
		]
	});
...
function member_del(obj,id){
	layer.confirm('确认要删除吗？',function(index){
		$.ajax({
			type: 'POST',
			url: '<?php echo url('grand/grandDelete'); ?>',
			data:{
				id: id
			},
			dataType: 'json',
