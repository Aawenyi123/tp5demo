<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:87:"C:\myphp_www\PHPTutorial\WWW\tp5\public/../application/index\view\grand\grand_edit.html";i:1561911500;s:72:"C:\myphp_www\PHPTutorial\WWW\tp5\application\index\view\public\base.html";i:1561699501;s:72:"C:\myphp_www\PHPTutorial\WWW\tp5\application\index\view\public\meta.html";i:1561524039;s:74:"C:\myphp_www\PHPTutorial\WWW\tp5\application\index\view\public\footer.html";i:1561709989;}*/ ?>
...
<article class="cl pd-20">
	...
	<form action="" method="post" class="form form-horizontal" id="form-member-add">
		<input type="hidden" name="" class="grandId" value="<?php echo $data['info']['id']; ?>">
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9" style="border:#e5e5e5 1px solid;border-radius:5px;">
				...
				<?php else: if(is_array($data['programList']) || $data['programList'] instanceof \think\Collection || $data['programList'] instanceof \think\Paginator): if( count($data['programList'])==0 ) : echo "" ;else: foreach($data['programList'] as $key=>$program): ?>
						...
						<?php if(in_array($program['id'], $data['proList']) == true): ?>
							checked="checked" 
						<?php endif; ?>
						>
						</span>
...
$(function(){
	...
	$('.btn-primary').on('click', function () {
		...
		$.ajax({
			type: 'POST',
			url: '<?php echo url('grand/grandUpdate'); ?>',
			data: data,
			dataType: 'json',
