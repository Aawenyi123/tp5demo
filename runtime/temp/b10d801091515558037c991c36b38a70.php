<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:85:"C:\myphp_www\PHPTutorial\WWW\tp5demo\public/../application/index\view\user\login.html";i:1561560579;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
		...
		<form class="form form-horizontal" action="index.html" method="post">
			...
			<div class="row cl">
				<div class="formControls col-xs-8 col-xs-offset-3">
					<input name="verify" class="input-text size-L" type="text" placeholder="验证码" onblur="if(this.value==''){this.value='验证码:'}" onclick="if(this.value=='验证码:'){this.value='';}" value="验证码:" style="width:120px;">
					<img id="verify" src="<?php echo captcha_src(); ?>"  alt="captcha" style="width:160px;margin-left:10px;" >
...
// 刷新验证码
	function refreshVerify() {
		var ts = Date.parse(new Date())/1000;// or Math.random();
