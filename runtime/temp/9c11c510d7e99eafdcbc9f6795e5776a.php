<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:91:"C:\myphp_www\PHPTutorial\WWW\tp5\public/../application/index\view\teacher\teacher_edit.html";i:1561972164;s:72:"C:\myphp_www\PHPTutorial\WWW\tp5\application\index\view\public\base.html";i:1561699501;s:72:"C:\myphp_www\PHPTutorial\WWW\tp5\application\index\view\public\meta.html";i:1561524039;s:74:"C:\myphp_www\PHPTutorial\WWW\tp5\application\index\view\public\footer.html";i:1561709989;}*/ ?>
...
<article class="cl pd-20">
	...
	<form action="" method="post" class="form form-horizontal" id="form-member-add">
		<input type="hidden" name="" class="teacherId" value="<?php echo $data['info']['id']; ?>">	
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>教师名：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text teacherName" value="<?php echo $data['info']['name']; ?>" placeholder="" id="username" name="teacherName">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9" style="border:#e5e5e5 1px solid;border-radius:5px;">
				...
				<?php else: if(is_array($data['programList']) || $data['programList'] instanceof \think\Collection || $data['programList'] instanceof \think\Paginator): if( count($data['programList'])==0 ) : echo "" ;else: foreach($data['programList'] as $key=>$program): ?>
						...
						<?php if(in_array($program['id'], $data['programIds']) == true): ?>checked="checked"<?php endif; ?> 
						>
						</span>
					<?php endforeach; endif; else: echo "" ;endif; endif; ?>
			</div>
...
$(function(){
	...
	$('.btn-primary').on('click', function () {
		...
		$.ajax({
			type: 'POST',
			url: '<?php echo url('teacher/teacherUpdate'); ?>',
			data: data,
			dataType: 'json',
