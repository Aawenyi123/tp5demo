<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:91:"C:\myphp_www\PHPTutorial\WWW\tp5\public/../application/index\view\student\student_list.html";i:1561972576;s:72:"C:\myphp_www\PHPTutorial\WWW\tp5\application\index\view\public\base.html";i:1561699501;s:72:"C:\myphp_www\PHPTutorial\WWW\tp5\application\index\view\public\meta.html";i:1561524039;s:74:"C:\myphp_www\PHPTutorial\WWW\tp5\application\index\view\public\header.html";i:1561737762;s:72:"C:\myphp_www\PHPTutorial\WWW\tp5\application\index\view\public\menu.html";i:1561947319;s:74:"C:\myphp_www\PHPTutorial\WWW\tp5\application\index\view\public\footer.html";i:1561709989;}*/ ?>
...
<section class="Hui-article-box">
	...
	<div class="Hui-article">
		<article class="cl pd-20">
			...
			<a href="javascript:;" onclick="member_add('添加学生','<?php echo url('student/studentAdd'); ?>','','510')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加学生</a></span>
			...
			<div class="mt-20">
				<table class="table table-border table-bordered table-hover table-bg table-sort">
					...
					<tbody>
						<?php if(is_array($data['list']) || $data['list'] instanceof \think\Collection || $data['list'] instanceof \think\Paginator): if( count($data['list'])==0 ) : echo "" ;else: foreach($data['list'] as $key=>$student): ?>
						<tr class="text-c">
							...
							<td ><?php echo $student['grandNames']; ?></td>
							<td><?php echo $student['detail']; ?></td>
							<td class="td-manage">
							<a title="编辑" href="javascript:;" onclick="member_edit('编辑','<?php echo url('student/studentEdit'); ?>','<?php echo $student['id']; ?>','','510')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
							<a title="删除" href="javascript:;" onclick="member_del(this,'<?php echo $student['id']; ?>')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
						</tr>
...
function member_del(obj,id){
	layer.confirm('确认要删除吗？',function(index){
		$.ajax({
			type: 'POST',
			url: '<?php echo url('student/studentDelete'); ?>',
			data: {id:id},
			dataType: 'json',
